...
IF (fs EQ 1) AND (ws EQ 1) AND (nx EQ 133) THEN fig_hw4.SAVE,'hw4_lw_1f1.pdf',RESOLUTION=512,/TRANSPARENT
IF (fs EQ 1) AND (ws EQ 1) AND (nx EQ 261) THEN fig_hw4.SAVE,'hw4_lw_1f2.pdf',RESOLUTION=512,/TRANSPARENT
