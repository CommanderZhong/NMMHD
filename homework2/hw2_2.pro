...
dt=c*dx
t=INDGEN(ABS(1./dt)+1)*dt
u1=u
c1=1./MAX(u)
dt1=c1*dx
t1=INDGEN(ABS(1./dt1)+1)*dt1

FOR n=0,1./dt-2 DO BEGIN
...
fig=PLOT(x,u[*,k],' ',/OVERPLOT,/CURR)
fig.SYMBOL='o'
fig.SYM_SIZE=1.5
fig=PLOT(x,u1[*,k1],/OVERPLOT,/CURR)
